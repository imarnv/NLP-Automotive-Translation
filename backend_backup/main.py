...
def translate_document(
    ...
    if filename_lower.endswith(".docx"):
        ...
        # XML in → XML out (preserve structure)
        docx_output = None
        output_filename = f"translated_{file.filename}"
    ...
    try:
        ...
        def translation_helper(sentences, lang_code, progress_callback=None):
            final_sentences = []
            # XML: larger batches + fast mode; DOCX: standard settings
            ...
            for i in range(0, total, batch_size):
                ...
                # 2. Translate Batch (fast_mode for XML)
        ...
        if filename_lower.endswith(".docx"):
            ...
            # XML pipeline: translate text nodes, preserve structure
